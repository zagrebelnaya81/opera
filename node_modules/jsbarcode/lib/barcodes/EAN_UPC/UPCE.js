...
function (_Barcode) {
  ...
  function UPCE(data, options) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(UPCE).call(this, data, options));
    _this.isValid = false;

    if (data.search(/^[0-9]{6}$/) !== -1) {
      _this.middleDigits = data;
      _this.upcA = expandToUPCA(data, '0');
      _this.text = options.text || "".concat(_this.upcA[0]).concat(data).concat(_this.upcA[_this.upcA.length - 1]);
      _this.isValid = true;
  ...
  _createClass(UPCE, [{
    ...
    value: function encodeMiddleDigits() {
      ...
      return (0, _encoder.default)(this.middleDigits, parity);
    }
  }]);
...
function expandToUPCA(middleDigits, numberSystem) {
  ...
  result = "".concat(numberSystem).concat(result);
  return "".concat(result).concat((0, _UPC.checksum)(result));
}
