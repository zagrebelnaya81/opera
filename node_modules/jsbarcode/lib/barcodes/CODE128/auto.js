...
var matchSetALength = function matchSetALength(string) {
  return string.match(new RegExp("^".concat(_constants.A_CHARS, "*")))[0].length;
};

var matchSetBLength = function matchSetBLength(string) {
  return string.match(new RegExp("^".concat(_constants.B_CHARS, "*")))[0].length;
};

var matchSetC = function matchSetC(string) {
  return string.match(new RegExp("^".concat(_constants.C_CHARS, "*")))[0];
