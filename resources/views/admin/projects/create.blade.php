...
@section('content')
    <div class="df mb15">
      <h1 class="global__page-title">{{__('admin.create_new_project')}}</h1>
    </div>

    <!-- if there are creation errors, they will show here -->
    @include('admin.errors')

    {{ Form::open(['url' => '/admin/projects', 'files' => true, 'id' => 'create-performance-type']) }}
    <div>
            ...
            <div role="tabpanel" class="tab-pane active" id="en">
              <div class="row">
                ...
                <div class="col-md-12 form-group">
                  ...
                  {{ Form::textarea('cond_description_en', Input::old('cond_description_en'), ['class' => 'form-control' ]) }}
                </div>
                <div class="col-md-6 form-group">
              ...
              <div class="row">
                ...
                <div class="col-md-12 form-group">
                  ...
                  <div class="col-md-12 form-group">
                      ...
                      {{ Form::textarea('cond_description_ru', Input::old('cond_description_ru'), ['class' => 'form-control' ]) }}
                  </div>
                <div class="col-md-6 form-group">
              ...
              <div class="row">
                ...
                <div class="col-md-12 form-group">
                  ...
                  <div class="col-md-12 form-group">
                      ...
                      {{ Form::textarea('cond_description_ua', Input::old('cond_description_ua'), ['class' => 'form-control' ]) }}
                  </div>
                <div class="col-md-6 form-group">
