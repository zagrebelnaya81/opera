  ...
  <div class="panel-body">
    ...
    <div class="row">
      ...
      <div class="col-md-6 form-group" style="margin-top: 10px">
        {{ Form::label('descriptions_old_' . $block->id, __('admin.phone')) }}
        {{ Form::tel('descriptions_old_' . $block->id, $block->translate('en')->first()->descriptions ?? Input::old('descriptions_old_' . $block->id), ['class' => 'form-control']) }}
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
