  ...
  <div class="panel-body">
    ...
    <div class="tab-content" data-tab-parent>
      <div role="tabpanel" class="tab-pane active" data-id="en">
        <div class="row">
          ...
          <div class="col-md-12 form-group">
            {{ Form::label('descriptions_en_old_' . $block->id, __('admin.description')) }}
      ...
      <div role="tabpanel" class="tab-pane" data-id="ru">
        <div class="row">
          ...
          <div class="col-md-12 form-group">
            {{ Form::label('descriptions_ru_old_' . $block->id, __('admin.description')) }}
      ...
      <div role="tabpanel" class="tab-pane" data-id="ua">
        <div class="row">
          ...
          <div class="col-md-12 form-group">
            {{ Form::label('descriptions_ua_old_' . $block->id, __('admin.description')) }}
    ...
    <div class="form-group">
      <label class="global__checkbox">
        {{ Form::checkbox('is_center_' .$block->id , 1, $block->is_center) }}
        <span class="global__checkbox-text">{{ __('admin.is_center') }}</span>
      </label>
    </div>
