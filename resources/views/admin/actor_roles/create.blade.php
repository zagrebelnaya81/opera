...
@section('content')
  <div class="df mb15">
    <h1 class="global__page-title">{{__('admin.createNewActorRole')}}</h1>
  </div>

  <!-- if there are creation errors, they will show here -->
  @include('admin.errors')

  {{ Form::open(['url' => '/admin/actor-roles', 'id' => 'create-title']) }}
  ...
  <div class="row">
    <div class="col-md-6 form-group">
      ...
      {{ Form::select('performance_id', $performances, null, ['class' => 'form-control']) }}
    </div>
  </div>
