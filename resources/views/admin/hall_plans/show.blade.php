...
@section('content')
  <div class="kasir-wrap">
    <div class="df mb15">
      ...
      <div class="fsh">
        <a class="btn btn-primary btn-sm" href="{{ route('halls.index') }}">Повернутися назад</a>
      </div>
    </div>
    <div class="kasir" id="kasir-recommendate" data-disabled>
        ...
        <div class="kasir__aside">
          <div class="kasir__prices">
            <h2 class="kasir__prices-title">Вибір кращого місця</h2>
