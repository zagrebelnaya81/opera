...
@section('content')
  <div class="df mb15">
    <h1 class="global__page-title">Створення нового комісійного збору</h1>
  </div>

  @include('admin.errors')

  {{ Form::open(['url' => '/admin/commissions', 'files' => true, 'id' => 'create-album-category']) }}
  <div>
  ...
  {{ Form::submit(__('admin.create'), ['class' => 'btn btn-success', 'required', 'number']) }}
